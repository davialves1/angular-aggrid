...
} from 'smart-webcomponents-angular/dockinglayout';
...
export class DockingComponent implements AfterViewInit {
  @ViewChild('slider', { read: SliderComponent, static: false })
  ...
  constructor() {
    // this.slider = new SliderComponent(this.slider);
  }
